...
window.kontext = function( container ) {
	...
	var layers = Array.prototype.slice.call( container.querySelectorAll( '.kontext-layer' ) );
	...
	function show( target, direction ) {
		...
		layers = Array.prototype.slice.call( container.querySelectorAll( '.kontext-layer' ) );
